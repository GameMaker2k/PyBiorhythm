...
if (not cairosupport and imageoutlib == "cairosvg"):
    imageoutlib = "pillow"
if (imageoutlib != "pillow" and imageoutlib !=
        "cairo" and imageoutlib != "cairosvg"):
    imageoutlib = "pillow"
...
if (pilsupport and imageoutlib == "pillow"):
    ...
    pre_biorhythm = cairo.SVGSurface(getargs.output, ((
        numdaysbackward + numdaysforward) - 1) * int(getargs.scalex), 210)
    biorhythm_img = cairo.Context(pre_biorhythm)
    biorhythm_img.set_antialias(cairo.ANTIALIAS_NONE)
    biorhythm_img.rectangle(
        0, 0, ((numdaysbackward + numdaysforward) - 1) * int(getargs.scalex), 210)
    biorhythm_img.set_source_rgb(255, 255, 255)
    biorhythm_img.fill()
elif (cairosupport and imageoutlib == "cairo"):
    pre_biorhythm = cairo.ImageSurface(cairo.FORMAT_RGB24, ((
        numdaysbackward + numdaysforward) - 1) * int(getargs.scalex), 210)
    biorhythm_img = cairo.Context(pre_biorhythm)
    biorhythm_img.set_antialias(cairo.ANTIALIAS_NONE)
    biorhythm_img.rectangle(
...
drawColorLine(biorhythm_img,
              ((numdaysbackward + numdaysforward) * int(getargs.scalex)) / 2,
              0,
              ((numdaysbackward + numdaysforward) * int(getargs.scalex)) / 2,
              210,
              (0,
...
while (int(curyear + curmonth + curday) < int(endyear + endmonth + endday)):
    ...
    if (curnum > 1 and "emotional" in getargs.show):
        drawColorLine(biorhythm_img, oldpos, (oldemotional + 104),
                      curpos, (emotional + 104), (51, 128, 51))
    if (getargs.verbose and "emotional" in getargs.show):
        if (getargs.verbosetype == "text"):
    ...
    if (curnum > 1 and "physical" in getargs.show):
        drawColorLine(biorhythm_img, oldpos, (oldphysical + 104),
                      curpos, (physical + 104), (153, 51, 51))
    if (getargs.verbose and "physical" in getargs.show):
        if (getargs.verbosetype == "text"):
    ...
    if (curnum > 1 and "intellectual" in getargs.show):
        drawColorLine(biorhythm_img, oldpos, (oldintellectual + 104),
                      curpos, (intellectual + 104), (51, 51, 170))
    if (getargs.verbose and "intellectual" in getargs.show):
        if (getargs.verbosetype == "text"):
    ...
    if (curnum > 1 and "average" in getargs.show):
        drawColorLine(biorhythm_img, oldpos, (oldaverage + 104),
                      curpos, (average + 104), (0, 0, 0))
    if (getargs.verbose and "average" in getargs.show):
        if (getargs.verbosetype == "text"):
    ...
    if (curnum > 1 and "spiritual" in getargs.show):
        drawColorLine(biorhythm_img, oldpos, (oldspiritual + 104),
                      curpos, (spiritual + 104), (89, 51, 189))
    if (getargs.verbose and "spiritual" in getargs.show):
        if (getargs.verbosetype == "text"):
    ...
    if (curnum > 1 and "intuition" in getargs.show):
        drawColorLine(biorhythm_img, oldpos, (oldintuition + 104),
                      curpos, (intuition + 104), (100, 60, 51))
    if (getargs.verbose and "intuition" in getargs.show):
    ...
    if (curnum > 1 and "awareness" in getargs.show):
        drawColorLine(biorhythm_img, oldpos, (oldawareness + 104),
                      curpos, (awareness + 104), (51, 138, 144))
    if (getargs.verbose and "awareness" in getargs.show):
        if (getargs.verbosetype == "text"):
    ...
    if (curnum > 1 and "aesthetic" in getargs.show):
        drawColorLine(biorhythm_img, oldpos, (oldaesthetic + 104),
                      curpos, (aesthetic + 104), (171, 51, 141))
    if (getargs.verbose and "aesthetic" in getargs.show):
        if (getargs.verbosetype == "text"):
    ...
    if (len(curmonth) == 1):
        curday = "0" + curmonth
    curnum = curnum + 1
if (getargs.display and pilsupport and imageoutlib == "pillow"):
    pre_biorhythm.show()
if (getargs.output is not None):
    if (pilsupport and imageoutlib == "pillow"):
